<?php
/* developed by zhayyn™ - Ultra Clean Material Edition */
    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; }
            ...
            .jadwal-table { width: 100%; border-collapse: collapse; background: #ffffff; table-layout: fixed; }
            ...
            .jadwal-table thead { 
                ...
                background: #174a38; /* Warna hijau pekat ala Mungkid */
            ...
            .jadwal-table th { color: #ffffff; padding: 14px 10px; font-size: 13px; font-weight: 600; text-transform: uppercase; border-bottom: 4px solid #cddc39; /* Garis aksen hijau lemon */ text-align: left; }
            .jadwal-table td { padding: 12px 10px; font-size: 12px; color: #333333; border-bottom: 1px solid #eeeeee; vertical-align: middle; box-sizing: border-box; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
            
            .jadwal-table tbody tr:nth-child(odd) { background-color: #ffffff; }
            .jadwal-table tbody tr:nth-child(even) { background-color: #f8f9fa; }
            
            .jadwal-table tbody:hover { animation-play-state: paused !important; cursor: pointer; }
            .jadwal-table tbody tr:hover { background-color: #f1f8f5; }
            
            .jadwal-table td:nth-child(1) { font-weight: 600; color: #174a38; }
            .jadwal-table td:nth-child(4) { font-weight: 600; color: #c0ca33; }
...
<head>
    ...
    <style>
        /* developed by zhayyn™ - Ultra Clean Edition */
        :root { 
            --hijau-gelap: #174a38; /* Hijau pekat Mungkid */
            --aksen-lemon: #cddc39; /* Garis aksen hijau stabilo/lemon */
        }
        
        body { 
            /* GANTI URL DI BAWAH DENGAN LINK GAMBAR PALU/TIMBANGAN TUAN MUDA */
            background-image: linear-gradient(rgba(23, 74, 56, 0.92), rgba(23, 74, 56, 0.95)), url('MASUKKAN_URL_GAMBAR_DI_SINI');
        ...
        .bg-hijau-elegan { background: var(--hijau-gelap) !important; color: white !important; border-bottom: 4px solid var(--aksen-lemon); }
        .teks-hijau { color: var(--hijau-gelap) !important; }
        .bg-oranye { background-color: var(--aksen-lemon) !important; color: #174a38 !important; } /* Kotak jam diubah agar matching */
        
        /* KARTU KEMBALI BERSIH & FLAT */
        .kartu-utama { 
            background: #ffffff; 
            border-radius: 8px; 
            ...
            overflow: hidden; 
            margin: 15px; 
            color: #333333; /* Teks dalam kartu jadi hitam */
        }

        .header-kartu { padding: 15px; font-weight: 600; text-align: center; border-bottom: 2px solid #eaeaea; }
        .badge-elegan { background-color: var(--hijau-gelap); color: #ffffff; border-radius: 6px; padding: 5px 15px; font-weight: bold; }
        .grid-ruang { display: grid; grid-template-columns: 1fr 1fr 1fr; text-align: center; padding: 20px 15px; gap: 10px; }
        .garis-batas { border-right: 1px dashed #cccccc; }
        
        .botbar { background-color: var(--hijau-gelap); color: white; text-align: center; padding: 12px; font-size: 14px; position: fixed; bottom: 0; width: 100%; z-index: 1000; border-top: 2px solid var(--aksen-lemon); }
        .botbar a { color: var(--aksen-lemon); text-decoration: none; font-weight: bold; }
    </style>
</head>
<body>
...
<div style="padding-bottom: 60px;">
    <div class="bg-hijau-elegan" style="padding: 15px; text-align: center;">
        <span style="font-size: 18px;"><i class="fas fa-gavel" style="color:var(--aksen-lemon);"></i> <strong>LIVE MONITOR ANTRIAN SIDANG</strong> | <span id="tgl_indo"></span></span> 
        <span class="bg-oranye" id="jam" style="padding: 5px 15px; border-radius: 6px; margin-left: 10px; font-weight:bold;"></span>
    </div> 

    <div class="kartu-utama">
        <div style="text-align: center; padding-top: 15px; font-weight: 800; color: #777777; font-size: 13px; text-transform:uppercase; letter-spacing:1px;">Informasi Sidang Dalam Gedung</div>
        <div class="grid-ruang">
            <div class="garis-batas">
                <div class="teks-hijau" style="font-size: 14px;"><b>RUANG SIDANG UTAMA</b></div>
                <div style="color:#777; font-size: 12px; margin: 8px 0;"><span id="noperk1">---</span></div>
                <div class="badge-elegan"><span id="no1">---</span></div>
            </div>
            <div class="garis-batas">
                <div class="teks-hijau" style="font-size: 14px;"><b>RUANG SIDANG 2</b></div>
                <div style="color:#777; font-size: 12px; margin: 8px 0;"><span id="noperk2">---</span></div>
                <div class="badge-elegan"><span id="no2">---</span></div>
            </div>
            <div>
                <div class="teks-hijau" style="font-size: 14px;"><b>RUANG SIDANG 3</b></div>
                <div style="color:#777; font-size: 12px; margin: 8px 0;"><span id="noperk3">---</span></div>
                <div class="badge-elegan"><span id="no3">---</span></div>
            </div>
        </div>
    </div>

    <div class="kartu-utama" style="margin-top: 20px;">
        <div class="bg-hijau-elegan" style="padding: 12px; text-align: center; font-size: 14px; font-weight: bold;">JADWAL PERSIDANGAN HARI INI</div>
        <iframe id="sippFrame" src="?format_jadwal=1&t=0" width="100%" height="450px" frameborder="0" scrolling="no" style="display:block; border: none; background: #ffffff;"></iframe>
    </div>
</div>

<div class="botbar">
    <i class="fas fa-thumbtack" style="color: var(--aksen-lemon); margin-right: 5px;"></i> Detail jadwal pada <a href="https://sipp.pa-semarang.go.id" target="_blank">SIPP</a> atau <a href="https://lumpiapasar.pa-semarang.go.id" target="_blank">LUMPIAPASAR</a>
</div>
