...
Untuk pembacaan paling singkat, baca urutannya begini:

1. `DOCS-GUIDE-LAWANGSEWU.md`
2. `MIGRATION-STATUS-EXECUTIVE-LAWANGSEWU.md`
3. dokumen ini

Status terbaru per 2026-03-15:

- Lawangsewu sudah resmi diposisikan sebagai `CI4 Core` pada level arsitektur
- tetapi cutover produksi final tunggal masih belum selesai penuh
- report detail lengkap status migrasi ada di `MIGRATION-REPORT-DETAIL-LAWANGSEWU.md`
