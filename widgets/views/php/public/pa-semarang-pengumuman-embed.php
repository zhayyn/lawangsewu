...
async function loadEmbedFeed() {
    try {
        ...
        const candidates = [
            `${window.location.origin}/api/pengumuman-rss?source=${encodeURIComponent(activeSource)}&limit=${limit}`,
            `${window.location.origin}/lawangsewu/api/pengumuman-rss?source=${encodeURIComponent(activeSource)}&limit=${limit}`,
            `${window.location.origin}/widgets/views/php/api/api-pengumuman-rss.php?source=${encodeURIComponent(activeSource)}&limit=${limit}`,
            `${window.location.origin}/lawangsewu/widgets/views/php/api/api-pengumuman-rss.php?source=${encodeURIComponent(activeSource)}&limit=${limit}`,
        ];
        ...
        if (!payload || !payload.ok) {
            throw new Error('Gagal mengambil pengumuman');
        }
