...
## Deploy dan Sinkronisasi Lawangsewu

Gunakan script berikut untuk sinkronisasi source ke folder aktif Lawangsewu:
...
- nama script masih mengikuti penamaan legacy, tetapi dipakai untuk alur deploy sinkronisasi Lawangsewu pada root project ini
